---
citekey: avron1994stability
work:
  title: "Stability, Sequentiality and Demand Driven Evaluation in Dataflow"
  author: "Arnon Avron, Nada Sasson"
  venue: "Formal Aspects of Computing"
  date: 1994
  doi: 10.1007/BF03259389
read: full-text
source: "Full author copy, https://www.cs.tau.ac.il/~aa/articles/nada.pdf, metadata checked against the version of record"
retrieved: "-"
notes-by: Codex (initial campaign); Claude Fable 5 (record migration)
notes-date: 2026-08-04
synthesis: "Formally defines the least demanded computation for a fixed dataflow program, concrete inputs, and requested output-token positions, subsuming the fixed-input semantic part of an enabled-closure story under stability assumptions — but it does not range symbolically over inputs or enumerate projected selection records."
---
