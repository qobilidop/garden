...
read: full-text
source: "Journal PDF via https://doi.org/10.1017/S1471068411000263"
retrieved: "-"
notes-by: Codex (initial campaign); Claude Fable 5 (record migration)
notes-date: 2026-08-04
synthesis: "Establishes that shared choice identifiers in term-graph rewriting already guarantee sound, evaluation-order-independent exhaustive enumeration of consistent results — the term-graph exhaustive-choice baseline any graph-selection enumeration claim must clear"
---
...
What is directly established by the work: choice identities survive graph
transformation, shared choices resolve consistently, and legal evaluation
transformations preserve exactly the set of results.

Our interpretation or inference: our selection sites are deterministic and
input-guarded rather than nondeterministic. Our sparse observation also
distinguishes which structural sites are demanded by a chosen output
observation. Nevertheless, sharing and schedule independence need real
proofs; they are not consequences of treating the graph as an unshared
expression tree.

Could it subsume our proposed contribution: it subsumes generic claims about
term-graph choices, consistent sharing, exhaustiveness, and evaluation-order
independence. It does not directly yield input guards, symbolic residual
functions, or fibers of a deterministic structural observation.
