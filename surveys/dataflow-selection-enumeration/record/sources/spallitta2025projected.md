# spallitta2025projected — Disjoint Projected Enumeration for SAT and SMT

- **Status:** deep-read
- **Primary source:** https://doi.org/10.1016/j.artint.2025.104346
- **Version read:** author preprint, arXiv:2410.18707v2
- **Bibliography key:** `spallitta2025projected`
...
Complete disjoint projected enumeration of compact partial SAT and SMT models
without blocking clauses.

### What is our interpretation or inference?

Encode each selection occurrence as an important finite-domain observation
with an explicit inactive value. Project the internal graph equations and
unobserved values. This yields the same set of total observation tuples as the
...
Yes, it subsumes enumeration after a polynomial-size activation/outcome
instrumentation. A viable original contribution must establish a
compositional observation semantics or a structure-directed advantage over
this reduction, not merely reimplement projected AllSMT.
