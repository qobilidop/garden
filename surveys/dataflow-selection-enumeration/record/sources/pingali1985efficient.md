---
citekey: pingali1985efficient
work:
  title: "Efficient Demand-Driven Evaluation. Part 1"
  author: "Keshav Pingali, Arvind"
  venue: "ACM Transactions on Programming Languages and Systems"
  date: 1985
  doi: 10.1145/3318.3480
read: full-text
source: "MIT-LCS-TM-242 full report via https://hdl.handle.net/1721.1/149052; article metadata checked by DOI (https://doi.org/10.1145/3318.3480)"
retrieved: "-"
notes-by: Codex (initial campaign); Claude Fable 5 (record migration)
notes-date: 2026-08-04
synthesis: "Gives a local, structure-directed reverse-demand transformation for stream dataflow graphs, proved correct and parsimonious compositionally — computing one demanded evaluation for fixed inputs, not enumerating the range of a selection-observation projection over symbolic inputs"
---
...
Read at full-text level (MIT-LCS-TM-242 full report); the note records no
