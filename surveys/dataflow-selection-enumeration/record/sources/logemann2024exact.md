...
work:
  ...
  author: "Torben Logemann, Eric Veith"
  venue: "EXPLAINS 2024"
  date: 2024
  doi: 10.5220/0012928000003886
read: full-text
source: "EXPLAINS 2024 publisher PDF, pp. 96--107, https://doi.org/10.5220/0012928000003886"
retrieved: "-"
notes-by: Codex (initial campaign); Claude Fable 5 (record migration)
notes-date: 2026-08-04
synthesis: "Names and geometrically analyzes exact output regions of feed-forward RL policy networks, extending NN2EQCDT to represent each root-to-leaf decision-tree path as a convex polytope paired with the leaf's affine output function — output regions as exact guards with affine residuals for the policy-network specialization."
---
