...
- `semantics.md`: eager values, selection observations, and exact fibers.
- `enumeration.md`: concolic fiber generation and projected-AllSMT reduction.
- `composition.md`: demand-parametric summaries and exact composition.
- `complexity.md`: size parameters, baselines, and complexity caveats.
