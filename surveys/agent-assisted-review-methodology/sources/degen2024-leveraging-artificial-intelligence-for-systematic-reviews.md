# degen2024-leveraging-artificial-intelligence-for-systematic-reviews — FRAISR: a cross-disciplinary AI reporting framework for SRs

- **Status:** G1 deep-read
- **Work:** doi:10.31219/osf.io/ju8dk — Degen, Vogel & Rzejak (2024), "Leveraging
  Artificial Intelligence for Systematic Reviews: The FRAISR Reporting
  Framework and guidance for researchers" (OSF preprint, University of Kassel)
- **Source:** transcript at
  shadow/library/papers/2024/degen2024-leveraging-artificial-intelligence-for-systematic-reviews/transcript.md
- **Facets:** stage=report, contribution=guideline, setting=general
  (cross-disciplinary; explicitly contrasts itself with medicine-only
  extensions)
