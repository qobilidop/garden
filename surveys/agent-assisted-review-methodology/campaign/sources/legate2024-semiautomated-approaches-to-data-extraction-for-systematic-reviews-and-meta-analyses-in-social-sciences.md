# legate2024-semiautomated-approaches-to-data-extraction-for-systematic-reviews-and-meta-analyses-in-social-sciences — baseline living review of (semi)automated data-extraction tools for social-science SRs

- **Status:** G1 deep-read
- **Work:** doi:10.12688/f1000research.151493.2 — Legate, Nimon & Noblin
  (2024), "(Semi)automated approaches to data extraction for systematic
  reviews and meta-analyses in social sciences: A living review"
  (F1000Research 13:664, v2, gold OA CC-BY)
- **Source:** transcript at
  shadow/library/papers/2024/legate2024-semiautomated-approaches-to-data-extraction-for-systematic-reviews-and-meta-analyses-in-social-sciences/transcript.md
- **Facets:** stage=extract, contribution=evaluation, setting=general
  (social sciences broadly, explicitly modeled on and contrasted with the
  clinical/PICO extraction lineage — not a med setting itself)
