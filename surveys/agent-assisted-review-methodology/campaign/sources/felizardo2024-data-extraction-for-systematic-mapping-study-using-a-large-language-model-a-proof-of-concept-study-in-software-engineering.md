# felizardo2024-data-extraction-for-systematic-mapping-study-using-a-large-language-model-a-proof-of-concept-study-in-software-engineering — ChatGPT-4o data-extraction accuracy in one SE mapping study

- **Status:** abstract-only (no OA PDF found: unpaywall closed, OpenAlex
  best_oa_location=null, Semantic Scholar openAccessPdf.status=CLOSED, no
  arXiv preprint found by title search)
- **Work:** doi:10.1145/3674805.3690743 — Felizardo, Steinmacher, Lima,
  Deizepe, Conte & Barcellos (2024), "Data extraction for systematic
  mapping study using a large language model - a proof-of-concept study
  in software engineering" (ESEM '24 companion proceedings, ACM,
  closed access)
- **Source:** abstract via OpenAlex (abstract_inverted_index) and
  Semantic Scholar, cross-checked identical
- **Facets:** stage=extract, contribution=evaluation, setting=se
