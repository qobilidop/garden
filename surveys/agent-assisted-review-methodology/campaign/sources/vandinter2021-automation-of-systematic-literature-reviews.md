# vandinter2021-automation-of-systematic-literature-reviews — pre-LLM landscape SLR of SLR-automation studies (41 primary studies, 2006-2020)

- **Status:** G1 deep-read
- **Work:** doi:10.1016/j.infsof.2021.106589 — van Dinter, Tekinerdogan & Catal
  (2021), "Automation of systematic literature reviews: A systematic
  literature review", *Information and Software Technology* 136:106589
- **Source:** transcript at
  shadow/library/papers/2021/vandinter2021-automation-of-systematic-literature-reviews/transcript.md
  (green OA accepted-manuscript copy via Wageningen University repository,
  Taverne Amendment; PDF in Drive store)
- **Facets:** stage=meta, contribution=evaluation, setting=se
