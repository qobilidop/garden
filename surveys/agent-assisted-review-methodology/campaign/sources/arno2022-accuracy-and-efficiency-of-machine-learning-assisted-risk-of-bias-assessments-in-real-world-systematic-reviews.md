# arno2022-accuracy-and-efficiency-of-machine-learning-assisted-risk-of-bias-assessments-in-real-world-systematic-reviews — RobotReviewer-assisted vs. blank-form RoB assessment, noninferiority RCT

- **Status:** abstract-only (no OA PDF found: unpaywall closed, Semantic Scholar openAccessPdf empty, Europe PMC isOpenAccess=N/hasPDF=N, no UCL Discovery or Monash Research Repository copy)
- **Work:** doi:10.7326/m22-0092
- **Source:** abstract via PubMed (PMID:35635850) and Europe PMC; metadata via OpenAlex and Unpaywall
- **Facets:** stage=appraise, contribution=evaluation, evidence=human-agree, setting=med
