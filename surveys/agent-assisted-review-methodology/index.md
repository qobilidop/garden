...
| [Benchmarking Human–AI Collaboration for Common Evidence Appraisal Tools](https://doi.org/10.1016/j.jclinepi.2024.111533) | Agreement-gated deferral beats humans-alone and LLM ensembles on the easier instruments | J Clin Epi · 2024 | [notes](https://github.com/qobilidop/sys0/blob/main/surveys/agent-assisted-review-methodology/record/sources/woelfle2024-benchmarking-humanai-collaboration.md) |

### Ensembles and end-to-end systems

| Paper | What | Venue · Year | Notes |
|---|---|---|---|
| [Dual-Model LLM Ensemble Reaches Near-Perfect Sensitivity for Screening](https://doi.org/10.1101/2025.11.03.25339455) | Cross-family OR-ensemble; family diversity catches family blind spots | openRxiv · 2025 | [notes](https://github.com/qobilidop/sys0/blob/main/surveys/agent-assisted-review-methodology/record/sources/fagerberg2025-dual-model-llm-ensemble-via-web-chat-interfaces-reaches-near-perfect-sensitivity-for-systematic-review-screening.md) |
...
| [LLM4SCREENLIT: Assessing LLM Performance for Screening](https://arxiv.org/abs/2511.12635) | Measurement reform: why accuracy misleads under class imbalance | IST · 2026 | [notes](https://github.com/qobilidop/sys0/blob/main/surveys/agent-assisted-review-methodology/record/sources/madeyski2025-llm4screenlit.md) |
