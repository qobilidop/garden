...
paper and our notes on it (library pages where ingested, our
...
| [SESR-Eval: Dataset for Evaluating LLMs in Title-Abstract Screening](https://doi.org/10.1109/esem64174.2025.00053) | 9-LLM × 24-review benchmark; no model meets the deployment bar | ESEM · 2025 | [notes](https://github.com/qobilidop/sys0/blob/main/surveys/agent-assisted-review-methodology/record/sources/huotala2025-sesr-eval.md) |
...
| [(Semi)automated Approaches to Data Extraction for Systematic Reviews](https://doi.org/10.12688/f1000research.151493.2) | Living review of extraction tools in social science | F1000Research · 2024 | [notes](https://github.com/qobilidop/sys0/blob/main/surveys/agent-assisted-review-methodology/record/sources/legate2024-semiautomated-approaches-to-data-extraction-for-systematic-reviews-and-meta-analyses-in-social-sciences.md) |
...
| [Benchmarking Human–AI Collaboration for Common Evidence Appraisal Tools](https://doi.org/10.1016/j.jclinepi.2024.111533) | Agreement-gated deferral beats both humans-alone and LLM ensembles | J Clin Epi · 2024 | [notes](https://github.com/qobilidop/sys0/blob/main/surveys/agent-assisted-review-methodology/record/sources/woelfle2024-benchmarking-humanai-collaboration.md) |

### Ensembles and end-to-end systems

| Paper | What | Venue · Year | Notes |
|---|---|---|---|
| [Dual-Model LLM Ensemble Reaches Near-Perfect Sensitivity for Screening](https://doi.org/10.1101/2025.11.03.25339455) | Cross-family OR-ensemble; family diversity catches family blind spots | medRxiv · 2025 | [notes](https://github.com/qobilidop/sys0/blob/main/surveys/agent-assisted-review-methodology/record/sources/fagerberg2025-dual-model-llm-ensemble-via-web-chat-interfaces-reaches-near-perfect-sensitivity-for-systematic-review-screening.md) |
| [A PRISMA-Aligned Agentic Framework for Medical Systematic Reviews](https://doi.org/10.64898/2026.07.30.26359375) | MedSR-Copilot: reliability from decomposition and human gates, not redundancy | medRxiv · 2026 | [notes](https://github.com/qobilidop/sys0/blob/main/surveys/agent-assisted-review-methodology/record/sources/huang2026-a-prisma-aligned-agentic-framework-for-medical-systematic-reviews-and-evidence-synthesis.md) |
...
| [Responsible Integration of AI in Rapid Reviews](https://doi.org/10.1002/cesm.70063) | RAISE / Cochrane position: principles for responsible use | Cochrane Ev Synth · 2025 | [notes](https://github.com/qobilidop/sys0/blob/main/surveys/agent-assisted-review-methodology/record/sources/gartlehner2025-responsible-integration-of-artificial-intelligence-in-rapid-reviews.md) |
...
| [LLM4SCREENLIT: Assessing LLM Performance for Screening](https://arxiv.org/abs/2511.12635) | Measurement reform: why accuracy misleads under class imbalance | arXiv · 2025 | [notes](https://github.com/qobilidop/sys0/blob/main/surveys/agent-assisted-review-methodology/record/sources/madeyski2025-llm4screenlit.md) |
