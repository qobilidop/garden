// The person behind the site: the one home for name, handle, and
// outbound profiles. Nav, landing page, and footer all read from here.
// The name is the person (landing H1, CV, footer copyright); the handle
// is the site (domain, wordmark, tab suffix) and the account name on
// every service below, so the profile links derive from it.
