---
citekey: jiang2026-from-solvers-to-research
work:
...
the trust layer *above* the kernel: [[demoura2026-postmortem-for-kernel-soundness-bug]]
...
- [[openai2026-ten-advances-in-mathematics]] — this survey supplies
  ...
  compilation half).
- [[demoura2026-postmortem-for-kernel-soundness-bug]] — complementary
  trust layers: kernel soundness below, statement fidelity above.
  Together they bound what "machine-checked" actually certifies.
- [[liu2026-a-taxonomy-of-self-evolving-agents]] — the research-agent
...
- [[gao2025-a-survey-of-self-evolving-agents]] — genre sibling;
