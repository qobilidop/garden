---
citekey: favaro2026-when-ai-builds-itself
work:
...
That boundary matters against [[gao2025-a-survey-of-self-evolving-agents]]:
...
- **Weaknesses:** the underlying data, classifiers, judges, and most
  ...
  policy advocate.
- **Against the library:** [[jiang2026-from-solvers-to-research]] finds the
