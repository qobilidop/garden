...
- Surveys live in their own repositories (listed in
  `portfolio/portfolio.yaml`), outside the link namespace: a topic page
  or note that draws on one links it by plain URL, never `[[slug]]`.
